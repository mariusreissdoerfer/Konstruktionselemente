...
export function BolzenverbindungPage() {
  ...
  const [tG, setTG] = useLocalStorage('ke.bolzen.tG', 118)
  const [bS, setBS] = useLocalStorage('ke.bolzen.bS', 1010)
  const [bG, setBG] = useLocalStorage('ke.bolzen.bG', 1130)
  const [cS, setCS] = useLocalStorage('ke.bolzen.cS', 705)
  const [cG, setCG] = useLocalStorage('ke.bolzen.cG', 515)
  const [spalt, setSpalt] = useLocalStorage('ke.bolzen.spalt', 40)
  ...
  const [buchseLenS, setBuchseLenS] = useLocalStorage('ke.bolzen.buchseLenS', 236)
